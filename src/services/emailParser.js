 ...
 */
export function detectStage(subject, body) {
 ...
 */
export function detectRole(email, name, body) {
 ...
 */
export async function matchEmailToTransaction(parsedEmail, transactions) {
